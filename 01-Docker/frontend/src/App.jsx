...
import "./App.css";
const API_BASE = import.meta.env.VITE_API_BASE_URL || "http://wbd.localtest.me/api";
...
export default function App() {
  ...
  const fetchItems = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const res = await fetch(`http://localhost:4000/api/items`, { headers: { Accept: "application/json" } });
